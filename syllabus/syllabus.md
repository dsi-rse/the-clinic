...
<h3 align=center>Class Time: Tu/Th 5-6:20pm | Location: 5460 N University Room 105</h3>
...
* __20% Weekly Reports/Work Product__ –  [Project Mentors & TAs]  Each week each student receives a single score on a scale of 0-5 from their project mentor, covering the GitHub issues they opened for their tasks, the work they pushed, and the weekly report they posted as a comment on those issues. The full rubric is [here](../rubrics/weekly-report-rubric.md). This score is a measure of a student's effort and output for that particular week and may include the following dimensions:
